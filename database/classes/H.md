...
***Interception.*** When a creature you can see hits a target other than you within 5 feet of you with an attack, you can use your reaction to reduce the damage the target takes by 1d10 + your proficiency bonus (a minimum of 0 damage). You must be wielding a shield or a simple or martial weapon to use this reaction.
...
You gain the following two Channel Divinity options. See the Sacred Oath class feature for how Channel Di­vinity works.
...
:   *To view the lore of the Rogue class, see Rogue/lore.*
...
(Xanathar's Guide to Everything, page 46)
...
(Tasha's Cauldron of Everything, page 62)
...
* At the end of the long rest, a soul trinket appears in your hand if you don't have any soul trinkets, as the spirits of the dead are drawn to you.

## Scout[]

(Xanathar's Guide to Everything, page 47)
...
(Tasha's Cauldron of Everything, page 63)
...
(Xanathar's Guide to Everything, page 47; Sword Coast Adventurer's Guide, page 135)
...
# Rogue/Unearthed Arcana

< Rogue

:   *To view the official mechanics and statistics of this class, see Rogue.*
...
* 1 Fighter, Ranger, Rogue
  + 1.1 The Revived
    - 1.1.1 Tokens of Past Lives
    - 1.1.2 Revived Nature
    - 1.1.3 Bolts from the Grave
    - 1.1.4 Connect with the Dead
      * 1.1.4.1 Revived Capabilities
    - 1.1.5 Audience with Death
    - 1.1.6 Ethereal Jaunt

# Fighter, Ranger, Rogue[]

(Unearthed Arcana: Fighter, Ranger, Rogue])
...
* School of Evocation (Player's Handbook, page 117)
...
(Tasha's Cauldron of Everything, page 76; Sword Coast Adventurer's Guide, page 141)
...
You can use a bonus action to start the Bladesong, which lasts for 1 minute. It ends early if you are incapacitated, if you don medium or heavy armor or a shield, or if you use two hands to make an attack with a single weapon. You can also dismiss the Bladesong at any time (no action required).
...
(Explorer's Guide to Wildemount, page 184)

**This subclass is designed for Wildemount settings.** Check with your DM before using it in other settings.
...
(Explorer's Guide to Wildemount, page 185)

**This subclass is designed for Wildemount settings.** Check with your DM before using it in other settings.

### Dunamancy Spells[]

Graviturgy Magic lets you choose from an expanded list of spells when you learn a wizard spell. The following spells are added to the wizard spell list for you.

| Wizard Level | Spells |
| --- | --- |
| 1st | Sapping Sting, Magnify Gravity |
| 3rd | Fortune's Favor, Immovable Object, Wristpocket |
| 5th | Pulse Wave |
...
(Tasha's Cauldron of Everything, page 77)
...
*14th-level Order of the Scribes feature*
...
(Xanathar's Guide to Everything, page 59)
...
* 1 Giant Options
  + 1.1 Runecrafter
    - 1.1.1 Runes of Understanding
    - 1.1.2 Runic Empowerment
    - 1.1.3 Sigils of Warding
    - 1.1.4 Rune Maven
    - 1.1.5 Engraved Enmity
* 2 Eberron
  + 2.1 Artificer
    - 2.1.1 Infuse Potions
    - 2.1.2 Infuse Scrolls
    - 2.1.3 Infuse Weapons and Armor
    - 2.1.4 Superior Artificer
    - 2.1.5 Master Artificer
* 3 Warlock and Wizard
  + 3.1 Lore Mastery
    - 3.1.1 Lore Master
    - 3.1.2 Spell Secrets
    - 3.1.3 Alchemical Casting
    - 3.1.4 Prodigious Memory
    - 3.1.5 Master of Magic
* 4 Mages of Strixhaven
  + 4.1 Using These Subclasses
    - 4.1.1 Choosing the Subclass
    - 4.1.2 At Higher Levels
  + 4.2 Mage of Lorehold
    ...
    - 4.2.5 War Echoes
    - 4.2.6 History's Whims
  + 4.3 Mage of Prismari
    - 4.3.1 Using This Subclass
    - 4.3.2 Creative Skills
    - 4.3.3 Kinetic Artistry
    - 4.3.4 Favored Medium
    - 4.3.5 Focused Expression
    - 4.3.6 Impeccable Physicality
  + 4.4 Mage of Quandrix
    - 4.4.1 Using This Subclass
    - 4.4.2 Quandrix Spells
    - 4.4.3 Functions of Probability
    - 4.4.4 Velocity Shift
    - 4.4.5 Null Equation
    - 4.4.6 Quantum Tunneling
  + 4.5 Mage of Silverquill
    - 4.5.1 Using This Subclass
    - 4.5.2 Eloquent Apprentice
    - 4.5.3 Silvery Barbs
    - 4.5.4 Inky Shroud
    - 4.5.5 Infusion of Eloquence
    - 4.5.6 Word of Power
* 5 Cleric, Druid, and Wizard
  + 5.1 Onomancy
    - 5.1.1 Bonus Proficiencies
    - 5.1.2 Extract Name
    - 5.1.3 Fateful Naming
    - 5.1.4 Resonant Utterance
    - 5.1.5 Inexorable Pronouncement
    - 5.1.6 Relentless Naming
* 6 Fighter, Rogue, and Wizard
  + 6.1 Psionics
    - 6.1.1 Psionic Focus
    - 6.1.2 Psionic Devotion
    - 6.1.3 Thought Form
    - 6.1.4 Mental Discipline
    - 6.1.5 Empowered Psionics
    - 6.1.6 Thought Travel
* 7 Three Subclasses
  + 7.1 School of Invention
    - 7.1.1 Tools of the Inventor
    - 7.1.2 Arcanomechanical Armor
    - 7.1.3 Reckless Casting
    - 7.1.4 Alchemical Casting
    - 7.1.5 Prodigious Inspiration
    - 7.1.6 Controlled Chaos
* 8 Modern Magic
  + 8.1 Technomancy
    - 8.1.1 Bonus Proficiencies
    - 8.1.2 Technological Savant
    - 8.1.3 Program Spell
    - 8.1.4 Online Casting
    - 8.1.5 Chained Device
* 9 Wizard Revisited
  + 9.1 Theurgy
    - 9.1.1 Divine Inspiration
    - 9.1.2 Arcane Initiate
    - 9.1.3 Channel Arcana
      * 9.1.3.1 Channel Arcana: Divine Arcana
    - 9.1.4 Arcane Acolyte
    - 9.1.5 Arcane Priest
    - 9.1.6 Arcane High Priest
...
| 4th | +1 armor |
| 5th | +2 weapon or +2ammunition (20 pieces) |
| 6th | +2 armor |
